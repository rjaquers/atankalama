<?php
// Vista de Recuperación de Contraseña - Sistema de Contratos Atankalama
?>
<!doctype html>
<html lang="es">
<head>
  ...
  <title>Recuperar Contraseña - Sistema de Contratos Atankalama</title>
          ...
          <?php else: ?>
            <form method="post" action="<?= BASE_URL ?>/login/sendResetLink">
                ...
                <label class="form-label">
                    <i class="fa-solid fa-envelope text-muted"></i> Email
                </label>
