            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0">
                    <div
                        ...
                        <h2 class="h4 mb-0 text-gray-800">Editar Producto (#<?= $producto['producto_id'] ?>)</h2>
                    </div>
                    <div class="card-body p-4">
                        <form action="index.php?page=producto/editar&id=<?= $producto['producto_id'] ?>" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="number" class="form-control border-start-0 ps-0" id="precio"
                                        name="precio" required min="0" step="1"
                                        value="<?= intval($producto['precio']) ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 bg-light p-3 rounded border">
                                <div class="form-check form-switch form-switch-lg">
                                    <input class="form-check-input" type="checkbox" id="activo" name="activo" value="1"
                                        <?= $producto['activo'] ? 'checked' : '' ?> style="height: 1.5em; width: 3em;">
                            ...
                            <div class="d-flex justify-content-between pt-3">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg px-5">Actualizar Producto</button>
                            </div>
                        </form>
                    </div>
                </div>
