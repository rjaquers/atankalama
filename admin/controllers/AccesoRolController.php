...
class AccesoRolController
{
    public function list()
    {
        ...
        include __DIR__ . '/../views/acceso_roles_list.php';
    }
    ...
    public function create()
    {
        ...
        include __DIR__ . '/../views/acceso_roles_form.php';
    }
    ...
    public function edit()
    {
        ...
        include __DIR__ . '/../views/acceso_roles_edit.php';
    }
    ...
    public function secciones()
    {
        ...
        include __DIR__ . '/../views/acceso_roles_secciones.php';
    }
