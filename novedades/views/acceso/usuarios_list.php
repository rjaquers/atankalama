    ...
    <table id="tablaUsuarios" class="table table-striped table-hover align-middle">
        ...
        <?php foreach ($usuarios as $u): ?>
            ...
            <tr>
                ...
                <!-- Teléfono -->
                <td class="d-none d-md-table-cell" data-export="<?= htmlspecialchars($u['telefono'] ?? '—') ?>">
                ...
                <!-- RUT -->
                <td class="d-none d-md-table-cell"><?= htmlspecialchars($u['rut'] ?? '—') ?></td>
                <!-- Perfil -->
                <td data-export="<?= htmlspecialchars($u['perfil'] ?? '—') ?>">
                    <?php
                        $perfil = $u['perfil'] ?? '';
                ...
                <!-- Último acceso -->
                <td class="d-none d-md-table-cell" data-order="<?= $ts ?>" data-export="<?= htmlspecialchars($loginExport) ?>">
                    <?php if ($ts): ?>
        ...
        buttons: [
            {
                ...
                sheetName: 'Usuarios',
                exportOptions: {
                    // Columnas 0-9: todo excepto Acciones (índice 10)
